...
int main(int argc, char *argv[])
{
    ...
    while (!terminated)
    {
        ...
        if (FD_ISSET(TCPSock, &tempRecvSockSet))
        {
            ...
            int bytesRecv = recvfrom(UDPSock, (char *) &inBuffer, BUFFERSIZE, 0, (struct sockaddr *) &clientAddr, (socklen_t*)&size);
            ...
            int bytesSent = sendto(UDPSock, (char *) &inBuffer, bytesRecv, 0, (struct sockaddr *) &clientAddr, sizeof(clientAddr));
